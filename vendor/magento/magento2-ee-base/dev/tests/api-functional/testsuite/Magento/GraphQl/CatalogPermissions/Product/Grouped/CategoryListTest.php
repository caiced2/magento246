...
/**
 * Test presence/absence of grouped products via categoryList querying with
...
QUERY;
     ...
     * When a logged in customer queries for a category containing the grouped product
     * Then the category and its grouped product are returned in the response
     *
     * @magentoConfigFixture catalog/magento_catalogpermissions/enabled 1

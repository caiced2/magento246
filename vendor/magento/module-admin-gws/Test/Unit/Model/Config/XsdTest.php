...
class XsdTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->_xsdSchema = $urnResolver->getRealPath(
            'urn:magento:module:Magento_AdminGws:etc/admingws.xsd'
        );
    ...
    {
        $xmlString = file_get_contents(__DIR__ . '/_files/valid_admingws.xml');
        $actualResult = $this->_xsdValidator->validate($this->_xsdSchema, $xmlString);
        $this->assertEmpty($actualResult);
    }

    /**
     * Data provider with invalid xml array according to admingws.xsd
     */
    public function schemaCorrectlyIdentifiesInvalidXmlDataProvider()
    {
        return include __DIR__ . '/_files/invalidAdminGwsXmlArray.php';
    }
}

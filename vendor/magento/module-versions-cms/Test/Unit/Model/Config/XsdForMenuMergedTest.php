...
class XsdForMenuMergedTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->_xsdSchema = $urnResolver->getRealPath(
            'urn:magento:module:Magento_VersionsCms:etc/menu_hierarchy_merged.xsd'
        );
    ...
    {
        $xmlString = file_get_contents(__DIR__ . '/_files/valid_menu_hierarchy_merged.xml');
        $actualResult = $this->_xsdValidator->validate($this->_xsdSchema, $xmlString);
        $this->assertEmpty($actualResult);
    }

    /**
     * Data provider with invalid xml array according to menu_hierarchy_merged.xsd
     */

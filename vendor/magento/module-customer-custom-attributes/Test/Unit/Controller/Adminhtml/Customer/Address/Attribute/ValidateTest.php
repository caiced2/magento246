...
/**
 * Unit tests for \Magento\CustomerCustomAttributes\Controller\Adminhtml\Customer\Address\Attribute\Validate class.
 *
...
class ValidateTest extends TestCase
{
    ...
    public function testExecuteWithException(): void
    {
        ...
        $this->request
            ->method('getParam')
            ->withConsecutive(['website'], ['message_key', 'message'])
            ->willReturnOnConsecutiveCalls(1, 'message');
     ...
     */
    private function prepareAttributeData(): Attribute
    {
        $data = [
            'attribute_code' => 'test',
            'entity_type' => 1,

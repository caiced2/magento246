...
class Interceptor extends \Magento\Banner\Block\Ajax\Data implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomerDataUrl');
        return $pluginInfo ? $this->___callPlugins('getCustomerDataUrl', func_get_args(), $pluginInfo) : parent::getCustomerDataUrl($route);
    }

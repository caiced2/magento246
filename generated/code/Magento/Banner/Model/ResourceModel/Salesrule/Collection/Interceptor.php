<?php
namespace Magento\Banner\Model\ResourceModel\Salesrule\Collection;

/**
 * Interceptor class for @see \Magento\Banner\Model\ResourceModel\Salesrule\Collection
 */
class Interceptor extends \Magento\Banner\Model\ResourceModel\Salesrule\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function addRuleIdsFilter(array $ruleIds) : \Magento\Banner\Model\ResourceModel\Salesrule\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRuleIdsFilter');
        return $pluginInfo ? $this->___callPlugins('addRuleIdsFilter', func_get_args(), $pluginInfo) : parent::addRuleIdsFilter($ruleIds);
    }

    /**
     * {@inheritdoc}
     */
    public function addIsActiveSalesRuleFilter(int $isActive = 1) : \Magento\Banner\Model\ResourceModel\Salesrule\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIsActiveSalesRuleFilter');
        return $pluginInfo ? $this->___callPlugins('addIsActiveSalesRuleFilter', func_get_args(), $pluginInfo) : parent::addIsActiveSalesRuleFilter($isActive);
    }

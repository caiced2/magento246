...
class Interceptor extends \Magento\Customer\Model\Attribute implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canBeSearchableInGrid');
        return $pluginInfo ? $this->___callPlugins('canBeSearchableInGrid', func_get_args(), $pluginInfo) : parent::canBeSearchableInGrid();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canBeFilterableInGrid');
        return $pluginInfo ? $this->___callPlugins('canBeFilterableInGrid', func_get_args(), $pluginInfo) : parent::canBeFilterableInGrid();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUsedInForms');
        return $pluginInfo ? $this->___callPlugins('getUsedInForms', func_get_args(), $pluginInfo) : parent::getUsedInForms();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getValidateRules');
        return $pluginInfo ? $this->___callPlugins('getValidateRules', func_get_args(), $pluginInfo) : parent::getValidateRules();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setValidateRules');
        return $pluginInfo ? $this->___callPlugins('setValidateRules', func_get_args(), $pluginInfo) : parent::setValidateRules($rules);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMultilineCount');
        return $pluginInfo ? $this->___callPlugins('getMultilineCount', func_get_args(), $pluginInfo) : parent::getMultilineCount();
    }

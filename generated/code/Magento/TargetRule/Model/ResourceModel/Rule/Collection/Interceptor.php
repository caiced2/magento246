<?php
namespace Magento\TargetRule\Model\ResourceModel\Rule\Collection;

/**
 * Interceptor class for @see \Magento\TargetRule\Model\ResourceModel\Rule\Collection
 */
class Interceptor extends \Magento\TargetRule\Model\ResourceModel\Rule\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addApplyToFilter');
        return $pluginInfo ? $this->___callPlugins('addApplyToFilter', func_get_args(), $pluginInfo) : parent::addApplyToFilter($applyTo);
    }

    /**
     * {@inheritdoc}
     */
    public function setPriorityOrder($direction = 'ASC')
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setPriorityOrder');
        return $pluginInfo ? $this->___callPlugins('setPriorityOrder', func_get_args(), $pluginInfo) : parent::setPriorityOrder($direction);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addProductFilter');
        return $pluginInfo ? $this->___callPlugins('addProductFilter', func_get_args(), $pluginInfo) : parent::addProductFilter($productId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSegmentFilter');
        return $pluginInfo ? $this->___callPlugins('addSegmentFilter', func_get_args(), $pluginInfo) : parent::addSegmentFilter($segmentId);
    }
    ...
    public function addWebsitesToResult($flag = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addWebsitesToResult', func_get_args(), $pluginInfo) : parent::addWebsitesToResult($flag);
    }
    ...
    public function addWebsiteFilter($websiteId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addWebsiteFilter', func_get_args(), $pluginInfo) : parent::addWebsiteFilter($websiteId);
    }
    ...
    public function addIsActiveFilter($isActive = 1)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addIsActiveFilter', func_get_args(), $pluginInfo) : parent::addIsActiveFilter($isActive);
    }

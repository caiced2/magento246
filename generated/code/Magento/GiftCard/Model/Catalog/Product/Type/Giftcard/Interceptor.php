...
class Interceptor extends \Magento\GiftCard\Model\Catalog\Product\Type\Giftcard implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isTypeCombined');
        return $pluginInfo ? $this->___callPlugins('isTypeCombined', func_get_args(), $pluginInfo) : parent::isTypeCombined($product);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isTypePhysical');
        return $pluginInfo ? $this->___callPlugins('isTypePhysical', func_get_args(), $pluginInfo) : parent::isTypePhysical($product);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isTypeVirtual');
        return $pluginInfo ? $this->___callPlugins('isTypeVirtual', func_get_args(), $pluginInfo) : parent::isTypeVirtual($product);
    }

...
class Interceptor extends \Magento\AdvancedSalesRule\Model\Rule\Condition\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isFilterable');
        return $pluginInfo ? $this->___callPlugins('isFilterable', func_get_args(), $pluginInfo) : parent::isFilterable();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFilterGroups');
        return $pluginInfo ? $this->___callPlugins('getFilterGroups', func_get_args(), $pluginInfo) : parent::getFilterGroups();
    }

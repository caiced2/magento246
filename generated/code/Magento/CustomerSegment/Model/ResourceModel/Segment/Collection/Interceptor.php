...
class Interceptor extends \Magento\CustomerSegment\Model\ResourceModel\Segment\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addEventFilter');
        return $pluginInfo ? $this->___callPlugins('addEventFilter', func_get_args(), $pluginInfo) : parent::addEventFilter($eventName);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCustomerCountToSelect');
        return $pluginInfo ? $this->___callPlugins('addCustomerCountToSelect', func_get_args(), $pluginInfo) : parent::addCustomerCountToSelect();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCustomerCountFilter');
        return $pluginInfo ? $this->___callPlugins('addCustomerCountFilter', func_get_args(), $pluginInfo) : parent::addCustomerCountFilter($customerCount);
    }

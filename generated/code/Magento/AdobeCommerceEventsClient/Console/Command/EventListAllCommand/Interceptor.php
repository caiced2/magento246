...
class Interceptor extends \Magento\AdobeCommerceEventsClient\Console\Command\EventListAllCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\AdobeCommerceEventsClient\Event\Collector\CollectorInterface $eventCollector, \Magento\Framework\Module\Dir $dir, ?string $name = null)
    {
        $this->___init();

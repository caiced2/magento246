...
/**
 * Test presence/absence of bundle products via categoryList querying with
...
QUERY;
     ...
     * When a logged in customer queries for a category containing the bundle product
     * Then the category and its bundle product are returned in the response
     *
     * @magentoConfigFixture catalog/magento_catalogpermissions/enabled 1

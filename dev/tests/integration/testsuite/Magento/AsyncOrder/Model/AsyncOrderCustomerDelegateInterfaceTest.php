 ...
 */
class AsyncOrderCustomerDelegateInterfaceTest extends TestCase
{
    /**
     ...
     * @return void
     */
    public function testDelegateNewAfterPlacingVirtualOrder(): void
    {
        $orderAutoincrementId = '100000001';
        /** @var Magento\AsyncOrder\Model\Order $orderModel */

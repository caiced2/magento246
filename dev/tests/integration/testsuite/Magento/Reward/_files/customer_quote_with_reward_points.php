...
Resolver::getInstance()->requireDataFixture('Magento/Reward/_files/reward_exchange_rates_one_to_one.php');
Resolver::getInstance()->requireDataFixture('Magento/Reward/_files/customer_with_five_reward_points.php');
...
/** @var PaymentDataImporter $importer */
$importer = $objectManager->get(PaymentDataImporter::class);
...
$quote->addProduct($productRepository->get('simple-1'), 1);
